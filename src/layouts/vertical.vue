    ...
    <div id="layout-wrapper" style="overflow-x: hidden">
        ...
        <div>
            ...
            >
                ...
                <!-- <picture
                    class="d-flex justify-content-center align-items-end mt-4"
                >
                    <img src="/BAQVERDE.png" alt="BAQVERDE" class="w-50"/>
                </picture> -->
                ...
                <!-- <picture
                    class="d-flex w-100 justify-content-start align-items-end position-absolute bottom-0 mb-4 ms-4"
                >
                    <img src="/BAQVERDE.png" alt="BAQVERDE" class="w-50"/>
                </picture> -->
