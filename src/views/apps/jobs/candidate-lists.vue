    ...
    methods: {
        setPages() {
            let numberOfPages = Math.ceil(
                this.candidatelist.length / this.perPage
            );
            this.pages = [];
        ...
        <BRow class="gy-2 mb-2" id="candidate-list">
            <BCol lg="12">
                <table class="table">
                  ...
                  <span v-if="resultQuery.length == 0 && !loading" class="w-100 text-center fs-4 text-muted pt-2 d-block">No se encontraron usuarios</span>
            </BCol>
        </BRow>
