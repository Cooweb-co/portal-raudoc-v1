  ...
  >
    <template #title>
      <BCol lg="8" class="mx-4">
        <picture
          class="w-100 row d-flex justify-content-start align-items-center mt-3"
        >
          <img
            src="/BAQVERDE.png"
            alt="BAQVERDE"
      ...
      <BRow class="mx-4">
        ...
        <BCol lg="8" md="12" sm="12" class="ps-4 d-flex align-items-center">
          ...
          >
            <span
              ><b>Radicado:</b>
              <b class="text-success">{{ " " + radicate?.idRadicate }}</b></span
            >
            <span><b>Fecha Rad:</b> {{ form.date }}</span>
            <span><b>Destino:</b> {{ form.area }}</span>
            <span><b>Rem/Des:</b> {{ form.names + " " + form.lastNames }}</span>
        ...
        <BCard no-body>
          ...
          <BCardBody>
            <BRow>
              ...
              <BCol lg="6" class="mb-3" v-if="showcompanyNameForm">
              ...
              <BCol :lg="showcompanyNameForm ? '6' : '3'" class="mb-3">
                <label for="username" class="form-label fw-bold"
              ...
              <BCol lg="12" class="mb-3">
                ...
                <div class="col-sm-12 col-md-2" style="width: 100%">
                  <ValidateLabel
                    v-bind="{ v$ }"
                    attribute="address"
                    style="width: 100%"
