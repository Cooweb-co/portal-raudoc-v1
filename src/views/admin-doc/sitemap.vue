...
<template>
    <Layout>
        <PageHeader title="Organigrama" pageTitle="Barranquilla Verde" />
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <BCardHeader>
                        <BCardTitle class="mb-0">Organigrama</BCardTitle>
                    </BCardHeader>
                    <BCardBody>
                            ...
                            <figure class="sitemap-horizontal">
                                <ul class="administration">
                                    <li>
                                        <ul class="director">
                                            <li>
                                                <BLink href="javascript:void(0);" class="fw-semibold"><span>Gerencia <br> <small>10002</small></span></BLink>
