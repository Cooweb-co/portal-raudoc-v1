...
const canTransfer = computed(() => {
  if (props.data?.numberOutClaim || props.data?.status == "Respondido")
    return false;
  return true;
});
...
<template>
        ...
        <BCard no-body v-else>
          <BCardBody>
            <div class="text-muted">
              ...
              <h6 class="fw-semibold text-uppercase mb-3 mt-5">
                Fundamentos legales:
              </h6>
                ...
                <BRow gy-3>
                  ...
                  <BCol lg="3" sm="6">
                    <div>
                      ...
                      <BBadge tag="div" :variant="setVariantState">{{
                        data.status
                      }}</BBadge>
                    </div>
                  </BCol>
            ...
            <BCardBody>
              <div class="table-responsive table-card">
                <table class="table table-borderless align-middle mb-0">
                  <tbody>
                    <tr>
                      <td class="fw-medium">Número de Radicación</td>
                      <td>{{ numberClaim }}</td>
                    </tr>
                    <tr>
  ...
  >
    ...
    <div class="body-modal px-2">
      <BRow class="p-0" style="width: 100%">
        <BCol lg="6" class="mb-3 pl-0">
          <label for="choices-privacy-status-input" class="form-label fw-bold"
            >Área</label
          >
          <Multiselect
      ...
      <div class="comments">
        ...
        <p class="text-muted">
          Escriba las acciones realizadas durante su gestión y/o aquellos
          comentarios que desea realizar al destinatario de la transferencia
        </p>
        <textarea
          class="form-control"
        ...
        <InputFile
          @emitFiles="emitFiles"
          title="AGREGA ARCHIVO PARA TRANSFERIR AL USUARIO (OPCIONAL)"
        />
      </div>
    </div>
    <div class="footer-modal p-2 mt-5">
      ...
      <button v-else type="button" class="btn btn-primary" @click="sendDestiny">
        Entregar
      </button>
    </div>
  </BModal>
