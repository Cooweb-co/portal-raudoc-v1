    ...
    <template v-if="layoutType === 'vertical' || layoutType === 'semibox'">
      <ul class="navbar-nav h-100" id="navbar-nav">
        ...
        <li class="menu-title">
          ...
          <span data-key="t-components">Radicación</span>
        </li>
        ...
        <li class="nav-item">
          <router-link class="nav-link menu-link" to="/form/file-uploads">
            <ArchiveIcon width="24" height="24" />
            <span data-key="t-dashboard">Cargar Documento</span>
          </router-link>
        </li>
        <li class="nav-item">
          <router-link class="nav-link menu-link" to="/pages/search-results">
...
<!-- 
        ...
        <li class="nav-item">
          <router-link class="nav-link menu-link" to="/jobs/candidate-lists">
            ...
            <span data-key="t-dashboard">Gestión de Usuarios</span>
          </router-link>
        </li>
        

        <li class="nav-item">
          <router-link class="nav-link menu-link" to="/gestion-documental/document-list">
            <SettingsIcon width="24" height="24" />
            <span data-key="t-dashboard">Tipos de Documentos</span>
          </router-link>
        </li>
