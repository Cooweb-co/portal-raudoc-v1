        ...
        <div class="d-flex align-items-center">
          ...
          <BDropdown variant="link" class="ms-sm-3 header-item topbar-user" toggle-class="rounded-circle arrow-none"
            ...
            <template #button-content>
              <span class="d-flex align-items-center">
                ...
                <span class="text-start ms-xl-2">
                  <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{user.displayName}}</span>
                  <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">Administrador</span>
                </span>
              </span>
            </template>
            <h6 class="dropdown-header">Hola {{user.displayName}}!</h6>
            ...
            <router-link class="dropdown-item" to="/apps/tasks-kanban">
              ...
              <span class="align-middle"> Espacio de Trabajo</span>
            </router-link>
